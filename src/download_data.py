...
if __name__ == "__main__":
     files = [
          ('https://assets-datascientest.s3.eu-west-1.amazonaws.com/drift_monitoring/green_tripdata_2022-01.parquet', 'data'),
          ('https://assets-datascientest.s3.eu-west-1.amazonaws.com/drift_monitoring/green_tripdata_2022-02.parquet', 'data')
     ]
