...
# this function have issue
# def prepare_db():
#     conn = psycopg.connect("host=database port=5432 user=postgres password=example")
#     cur = conn.cursor()
...
#         conn.commit()
#     conn.close()
#     conn = psycopg.connect("host=database port=5432 dbname=test user=postgres password=example")
#     cur = conn.cursor()
...
def prepare_db():
     # Create a connection with autocommit enabled for the CREATE DATABASE statement
     conn = psycopg.connect("host=database port=5432 user=postgres password=example", autocommit=True)
     cur = conn.cursor()
     ...
     # Close the connection used to create the database
     cur.close()
     conn.close()
...
def batch_monitoring_backfill():
    ...
    conn = psycopg.connect("host=database port=5432 dbname=test user=postgres password=example", autocommit=True)
